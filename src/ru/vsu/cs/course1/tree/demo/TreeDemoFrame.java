...
import static ru.vsu.cs.course1.tree.BinaryTreeAlgorithms.findMaxNumber;
...
public class TreeDemoFrame extends JFrame {
    ...
    public TreeDemoFrame() {
        ...
        buttonFindMax.addActionListener(actionEvent -> {
            showSystemOut(() -> {
                System.out.println("Максимальное значение:");
                System.out.println(findMaxNumber((SimpleBinaryTree<Integer>) tree));
            });
        });
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        buttonFindMax = new JButton();
        buttonFindMax.setText("Найти Максимум");
        panel6.add(buttonFindMax, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
